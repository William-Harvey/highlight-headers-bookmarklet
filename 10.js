javascript:(function(){
    ...
    viewHeadersButton.onclick = function() {
        ...
        // Add drag handle using SVG
        const dragHandle = document.createElement('div');
        dragHandle.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="black" d="M3 10h18a1 1 0 0 1 0 2H3a1 1 0 1 1 0-2zm0 5h18a1 1 0 0 1 0 2H3a1 1 0 1 1 0-2z"/></svg>`;
        ...
        // Make the report draggable using the drag handle
    ...
    function dragElement(el, event) {
        ...
        document.onmouseup = function() {
            ...
            document.onmouseup = null;  // Stop dragging
        };
    }
